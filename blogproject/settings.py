...
SECRET_KEY = "django-insecure-7%nsbbvh^rruw5%q$^ticwmk%3o=9452yogx0ya5*^3f#z=g%h"
...
INSTALLED_APPS = [
    ...
    "blogapp", #defining the blogapp
    "session", #definig the session
]
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR), 'templates'],#to add a templates folder to django project
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
